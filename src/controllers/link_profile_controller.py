from  src.utils.utils import JSONtoExcel, RotateAccounts, extract_profiles_from_company, remove_empty_elements, save_to_json, extract_link, remove_empty_elements, read_excel_file, save_counter, generate_random_time
from config.account import accounts
from json.decoder import JSONDecodeError
from factory import getLinkedin
from src.models.extractor import extract_json_data
from flatten_json import flatten



def link_profile_controller():
    json_array = []
